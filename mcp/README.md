...
Use it via the `mcp` package directly:

```go
import (
    "github.com/assagman/dsgo/core"
    "github.com/assagman/dsgo/mcp"
    "github.com/assagman/dsgo/module"
)

// Create Exa MCP client
exaClient, err := mcp.NewExaClient(apiKey)
if err != nil {
...
```go
import "github.com/assagman/dsgo/mcp"

// HTTP Transport
transport := mcp.NewHTTPTransport("https://your-mcp-server.com/mcp", "api-key")

// SSE Transport
transport := mcp.NewSSETransport("https://your-mcp-server.com/sse", "api-key")

// Create client with custom transport
client, err := mcp.NewClient(mcp.ClientConfig{Transport: transport})
```
