...
- Predict / CoT: [`examples/codebase_analysis`](../../examples/codebase_analysis/)
- Parallel: [`examples/modules/parallel`](../../examples/modules/parallel/)
- ReAct: [`examples/react_experiment`](../../examples/react_experiment/)
- Program: [`examples/project_review`](../../examples/project_review/)
- MultiChainComparison: [`examples/multi_chain_comparison`](../../examples/multi_chain_comparison/)
